    ...
    <main>
        <article>
            ...
            <section class="image-shop" id="home" aria-label="home">
                <!-- Gambar Shop -->
                <img src="/Kitter/assets/images/beklayanan.jpg" alt="Shop Image" class="image-shop">
                ...
                <div class="shop-text">
                    ...
                    <a href="#" class="btn-shop-now">LAYANAN</a>
                </div>
            </section>

            <section class="layanan">
                <div class="card-layanan">
                    <img src="/Kitter/assets/images/layanan3.jpg" alt="Grooming Service" class="card-image">
                    <h3 class="title-layanan">Grooming</h3>
                    <p class="description-layanan">Layanan grooming untuk menjaga kebersihan dan kesehatan bulu hewan peliharaan anda.</p>
                    <a href="{{ route('service.grooming') }}" class="layanan">MULAI LAYANAN</a>
                </div>                
                <div class="card-layanan">
                    <img src="/Kitter/assets/images/layanan2.jpg" alt="Veterinary Service" class="card-image">
                    <h3 class="title-layanan">Kesehatan</h3>
                    <p class="description-layanan">Layanan kesehatan untuk memastikan hewan peliharaan anda tetap sehat dan bugar.</p>
                    <a href="#" class="layanan">MULAI LAYANAN</a>
                </div>
                <div class="card-layanan">
                    <img src="/Kitter/assets/images/layanan1.jpg" alt="Training Service" class="card-image">
                    <h3 class="title-layanan">Pelatihan</h3>
                    <p class="description-layanan">Pelatihan khusus untuk meningkatkan kemampuan dan perilaku hewan peliharaan.</p>
                    <a href="{{ route('layanan.pelatihan') }}" class="layanan">MULAI LAYANAN</a>
                </div>
            </section>
